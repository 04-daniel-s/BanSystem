...
public class PlayerInfoCommand extends AbstractTeamCommand {
    ...
    public void commandBody(ProxiedPlayer player, String[] args) {
        ...
        player.sendMessage(getInfoPrefix() + "IP: §a" + minecraftPlayer.getIpAddress());
        ...
        player.sendMessage(getInfoPrefix() + "Mutestatus: §a" + (minecraftPlayer.isMuted() ? "§4Muted" : "§aNot muted"));
    ...
    public void sendUsage(ProxiedPlayer player) {
        player.sendMessage(getInfoPrefix() + "/pinfo <Player>");
    }
